            ...
            <div class="max-w-6xl mx-auto px-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"> 
                    ...
                    <MemberCard
                        ...
                        image="public/images/newheadshots/jones.jpg"
                        bio=|| view! {
                            <>
                    ...
                    <MemberCard
                        ...
                        image="public/images/newheadshots/evan.jpg"
                        bio=|| view! {
                            <>
                    ...
                    <MemberCard
                        ...
                        image="public/images/newheadshots/nicolas.jpg"
                        bio=|| view! { <></> }.into_any()
                    ...
                    <MemberCard
                        name="David Chen"
                        role="Senior Advisor"
                        image="public/images/newheadshots/david.jpg"
                        bio=|| view! {
                            <>
                    ...
                    <MemberCard
                        name="Jennifer Ren"
                        role="Board Member"
                        image="public/images/newheadshots/jen.jpg"
                        bio=|| view! { <></> }.into_any()
                    ...
                    <MemberCard
                        ...
                        role="Board Member"
                        image="public/images/newheadshots/szymon.jpg"
                        bio=|| view! { <></> }.into_any()
                    ...
                    <MemberCard
                        name="Tanya Zhang"
                        role="Board Member"
                        image="public/images/newheadshots/tanya.jpg"
                        bio=|| view! { <></> }.into_any()
                    ...
                    <MemberCard
                        name="Vincent Chen"
                        role="Board Member"
                        image="public/images/newheadshots/vincent.jpg"
                        bio=|| view! { <></> }.into_any()
                    ...
                    <MemberCard
                        name="Joe Zhou"
                        role="Board Member"
                        image="public/images/newheadshots/joe.jpg"
                        bio=|| view! { <></> }.into_any()
                    ...
                    <MemberCard
                        name="Timur Usmonov"
                        role="Board Member"
                        image="public/images/newheadshots/timur.jpg"
                        bio=|| view! { <></> }.into_any()
